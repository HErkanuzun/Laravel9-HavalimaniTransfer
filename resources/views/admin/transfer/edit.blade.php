...
<form role="form" action="/admin/transfer/store" method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" name="description" class="form-control" id="exampleInputDescription31" placeholder="Description">
    <small id="emailHelp" class="form-text text-muted">Cannot be empty</small>
  </div>
  
  <div class="mb-3">
    <label for="exampleFormControlTextarea1"  class="form-label">Detail</label>
    <textarea name="detail" class="form-control" id="exampleFormControlTextarea11" rows="3"></textarea>
  </div>
